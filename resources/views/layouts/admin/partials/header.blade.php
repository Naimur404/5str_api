<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="{{ route('index') }}"><img class="class2" src="{{asset('icon/'.$app_setting->logo)}}" alt=""></a></div>
      <div class="dark-logo-wrapper"><a href="{{ route('index') }}"><img class="img-fluid" src="{{asset('icon/'.$app_setting->logo)}}" alt="" width="55" height="20"></a></div>
